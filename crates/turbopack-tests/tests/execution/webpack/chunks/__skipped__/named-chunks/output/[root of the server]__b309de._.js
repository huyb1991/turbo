(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__b309de._.js", {
...
"[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/index.js [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {

it("should handle named chunks", function(done) {
    var sync = false;
    require.ensure([], function(require1) {
        require1("./empty?a");
        require1("./empty?b");
        testLoad();
        sync = true;
...
it("should be able to use named chunks in import()", function(done) {
    var sync = false;
    __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/empty.js??import1-in-chunk1 [test] (ecmascript, async loader)")(__turbopack_import__).then(function(result) {
        var i = 0;
        __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/empty.js??import2-in-chunk1 [test] (ecmascript, async loader)")(__turbopack_import__).then(function(result) {
            expect(sync).toBeTruthy();
            if (i++ > 0) done();
        }).catch(function(err) {
            done(err);
        });
        __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/empty.js??import3-in-chunk2 [test] (ecmascript, async loader)")(__turbopack_import__).then(function(result) {
...
it("should be able to use named chunk in context import()", function(done) {
    ...
    var mpty = "mpty";
    var sync = false;
    __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/empty2.js [test] (ecmascript, async loader)")(__turbopack_import__).then(function(result) {
        var i = 0;
        __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/empty3.js [test] (ecmascript, async loader)")(__turbopack_import__).then(function(result) {
            expect(sync).toBeTruthy();
            if (i++ > 0) done();
        }).catch(function(err) {
            done(err);
        });
        __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/named-chunks/input/empty4.js [test] (ecmascript, async loader)")(__turbopack_import__).then(function(result) {
            expect(sync).toBeFalsy();
            if (i++ > 0) done();
        }).catch(function(err) {
            done(err);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b309de._.js.map