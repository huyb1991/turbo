(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__b3e0c2._.js", {
...
"[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/parsing/input/empty.js??require.ensure:test [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {


}.call(this) }),
"[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/parsing/input/require.include.js [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {

module.exports = "require.include";

}.call(this) }),
"[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/parsing/input/index.js [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {
...
it("should handle bound function expressions", function(done) {
    require.ensure([], (function(require1) {
        ...
        require1.ensure([], (function(require1) {
            expect(this).toEqual({
                test: true
            });
            done();
...
it("should parse expression in require.ensure, which isn't a function expression", function(done) {
    require.ensure([], function() {
        expect(__turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/parsing/input/empty.js??require.ensure:test [test] (ecmascript)")).toEqual({});
        return function f() {
            done();
        };
    }());
...
it("should accept an already included module", function(done) {
    if (Math.random() < 0) __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/webpack/chunks/__skipped__/parsing/input/require.include.js [test] (ecmascript)");
    var value = null;
    require.ensure([], function(require1) {
        value = require1("./require.include");
    });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b3e0c2._.js.map