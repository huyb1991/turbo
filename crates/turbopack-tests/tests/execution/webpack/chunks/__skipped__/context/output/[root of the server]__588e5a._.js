(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__588e5a._.js", {
...
it("should also work in a chunk", function(done) {
    require.ensure([], function(require1) {
        var contextRequire = require1.context(".", false, /two/);
        expect(contextRequire("./two")).toBe(2);
        var tw = "tw";
        expect(require1("." + "/" + tw + "o")).toBe(2);
        done();
    });
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__588e5a._.js.map