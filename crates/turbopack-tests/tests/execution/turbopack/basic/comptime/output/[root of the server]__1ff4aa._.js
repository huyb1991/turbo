(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__1ff4aa._.js", {
...
"[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {


}.call(this) }),
"[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/index.js [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {
...
it("importing a not existing file should throw", ()=>{
    ...
    expect(()=>{
        (()=>{
            const e = new Error("Cannot find module './not-existing-file'");
...
function func() {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)");
    }
    if ("TURBOPACK compile-time truthy", 1) {
        __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)");
    } else {
...
function funcTenary() {
    ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : undefined;
    ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : undefined;
    ("TURBOPACK compile-time truthy", 1) ? __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)") : ("TURBOPACK unreachable", undefined);
    ("TURBOPACK compile-time truthy", 1) ? __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)") : ("TURBOPACK unreachable", undefined);
    ("TURBOPACK compile-time truthy", 1) ? __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)") : ("TURBOPACK unreachable", undefined);
    ("TURBOPACK compile-time truthy", 1) ? __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)") : ("TURBOPACK unreachable", undefined);
    const value = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/basic/comptime/input/ok.js [test] (ecmascript)");
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1ff4aa._.js.map