(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__a6fec6._.js", {
...
"[project]/crates/turbopack-tests/tests/execution/turbopack/async-modules/top-level-await/input/Actions.js [test] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
const UserApi = __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/async-modules/top-level-await/input/UserAPI.js [test] (ecmascript, async loader)")(__turbopack_import__);
...
const AlternativeCreateUserAction = async (name)=>{
    const { createUser } = await __turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/async-modules/top-level-await/input/UserAPI.js [test] (ecmascript, async loader)")(__turbopack_import__);
    return await createUser(name);
}; // Note: Using await import() at top-level doesn't make much sense
 //       except in rare cases. It will import modules sequentially.

})()),
"[project]/crates/turbopack-tests/tests/execution/turbopack/async-modules/top-level-await/input/index.js [test] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({});
var __TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$async$2d$modules$2f$top$2d$level$2d$await$2f$input$2f$Actions$2e$js__$5b$test$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/crates/turbopack-tests/tests/execution/turbopack/async-modules/top-level-await/input/Actions.js [test] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
it("should handle top level await", async ()=>{
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$async$2d$modules$2f$top$2d$level$2d$await$2f$input$2f$Actions$2e$js__$5b$test$5d$__$28$ecmascript$29$__["CreateUserAction"])("John");
    expect(res).toBe("fake data");
});
it("should handle top level await (alternative)", async ()=>{
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$async$2d$modules$2f$top$2d$level$2d$await$2f$input$2f$Actions$2e$js__$5b$test$5d$__$28$ecmascript$29$__["AlternativeCreateUserAction"])("John");
    expect(res).toBe("fake data");
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a6fec6._.js.map