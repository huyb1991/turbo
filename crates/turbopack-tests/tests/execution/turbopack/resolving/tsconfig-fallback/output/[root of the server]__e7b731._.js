(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__e7b731._.js", {
...
"[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/src/foo.ts [test] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
"[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/src/baz/foo.ts [test] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "default": ()=>__TURBOPACK__default__export__
});
const __TURBOPACK__default__export__ = "baz/foo";

})()),
"[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/index.js [test] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({});
var __TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$resolving$2f$tsconfig$2d$fallback$2f$input$2f$src$2f$foo$2e$ts__$5b$test$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/src/foo.ts [test] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$resolving$2f$tsconfig$2d$fallback$2f$input$2f$node_modules$2f40$foo$2f$bar$2f$index$2e$js__$5b$test$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/node_modules/@foo/bar/index.js [test] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$resolving$2f$tsconfig$2d$fallback$2f$input$2f$src$2f$baz$2f$foo$2e$ts__$5b$test$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/src/baz/foo.ts [test] (ecmascript)");
...
it("should resolve an alias to a local file", ()=>{
    expect(__TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$resolving$2f$tsconfig$2d$fallback$2f$input$2f$src$2f$foo$2e$ts__$5b$test$5d$__$28$ecmascript$29$__["default"]).toBe("foo");
    expect(__turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/src/foo.ts [test] (ecmascript)")).toHaveProperty("default", "foo");
});
it("should fallback from an alias", ()=>{
    expect(__TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$resolving$2f$tsconfig$2d$fallback$2f$input$2f$node_modules$2f40$foo$2f$bar$2f$index$2e$js__$5b$test$5d$__$28$ecmascript$29$__["default"]).toBe("@foo/bar");
    expect(__turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/node_modules/@foo/bar/index.js [test] (ecmascript)")).toHaveProperty("default", "@foo/bar");
});
it("should prefer alias over normal resolving", ()=>{
    expect(__TURBOPACK__imported__module__$5b$project$5d2f$crates$2f$turbopack$2d$tests$2f$tests$2f$execution$2f$turbopack$2f$resolving$2f$tsconfig$2d$fallback$2f$input$2f$src$2f$baz$2f$foo$2e$ts__$5b$test$5d$__$28$ecmascript$29$__["default"]).toBe("baz/foo");
    expect(__turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/src/baz/foo.ts [test] (ecmascript)")).toHaveProperty("default", "baz/foo");
});
...
"[project]/crates/turbopack-tests/tests/execution/turbopack/resolving/tsconfig-fallback/input/node_modules/@foo/bar/index.js [test] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "default": ()=>__TURBOPACK__default__export__
});
const __TURBOPACK__default__export__ = "@foo/bar";

})()),
}]);

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e7b731._.js.map