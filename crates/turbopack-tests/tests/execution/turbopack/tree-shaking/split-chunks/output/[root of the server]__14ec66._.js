(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["[root of the server]__14ec66._.js", {
...
"[project]/crates/turbopack-tests/tests/execution/turbopack/tree-shaking/split-chunks/input/index.js [test] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require }) { !function() {

it("should load chunk a", async ()=>{
    await expect(__turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/tree-shaking/split-chunks/input/a.js [test] (ecmascript, async loader) <facade>")(__turbopack_import__)).resolves.toHaveProperty("default", "a");
});
it("should load chunk b", async ()=>{
    await expect(__turbopack_require__("[project]/crates/turbopack-tests/tests/execution/turbopack/tree-shaking/split-chunks/input/b.js [test] (ecmascript, async loader) <facade>")(__turbopack_import__)).resolves.toHaveProperty("default", "b");
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__14ec66._.js.map